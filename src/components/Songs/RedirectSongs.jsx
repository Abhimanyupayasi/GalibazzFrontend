  ...
  return (
    <div className="mb-5">
      <div
        ...
        role="alert"
        className="max-w-[350px] cursor-pointer p-2 bg-purple-700 rounded-full items-center text-yellow-100 leading-none lg:rounded-full flex lg:inline-flex transition duration-300 ease-in-out hover:bg-purple-900"
      >
        <span className="flex rounded-full bg-green-600 uppercase px-2 py-1 text-xs font-bold mr-3">Hot</span>
        <span className="font-semibold mr-2 text-left flex-auto">
          Discover Trending Songs Now!
        </span>
        <svg
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
